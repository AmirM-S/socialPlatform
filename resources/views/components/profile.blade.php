<x-layout :docTitle="$docTitle">
    <div class="container py-md-5 container--narrow">
        ...
        <div class="profile-nav nav nav-tabs pt-2 mb-4">
          ...
          <a href="/profile/{{$sharedData['username']}}/followings" class="profile-nav-link nav-item nav-link {{ Request::segment(3) == "followings" ? "active" : "" }}">Following: {{$sharedData['followingCount']}}</a>
        </div>
